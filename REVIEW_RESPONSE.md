...
| 4 | Ablations mixed | DONE: 500-seed factorial ablation toggles each factor one at a time; a hard weak-target scenario shows max-min gains of 2.45-3.45 pp; a quantization study adds a water-filling-inspired greedy (not claimed optimal) and an exact joint bit-allocation/selection oracle that beats the greedy by 0.63-0.89 pp at B=18/20 and matches it at B=24. |
