...
| `joint-power-comparison` | MAPPO vs Greedy vs WTA-Exact joint power-bit | `& "E:\anaconda\conda\python.exe" scripts\run_joint_power_comparison.py --reports 2 --targets 2 --budgets 8 10 12 --episodes 300 --train-seeds 30 --test-seeds 20 --output results\joint_power_comparison.json` | `results/joint_power_comparison.json` |
