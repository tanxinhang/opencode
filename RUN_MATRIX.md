...
| `physical-ppo-nomp` | PPO + NOMP under physical hard channels | `& "E:\anaconda\conda\python.exe" scripts\run_physical_ppo_nomp_gate.py --reports 2 4 --episodes 100 --train-seeds 20 --test-seeds 10 --output results\physical_ppo_nomp_gate.json --figure paper_figures\physical_ppo_nomp.png` | `results/physical_ppo_nomp_gate.json`, `paper_figures/physical_ppo_nomp.png` |
