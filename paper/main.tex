...
With five reports per target, the same sweep gives frontier size at most $1+5\cdot 4=21$ and keeps exact-joint gains of 1.5-2.7 pp over greedy at $Q=2/3/5/8/12/20$ (5 seeds), with threshold DP still below 0.2 ms.  The option generation remains enumeration-based and is therefore limited to $R=5$ in this paper ($5^5=3125$ options per target); generating the frontier by branch-and-bound for $R\ge 8$ is a natural extension, and Proposition 1 bounds the frontier independently of $R$.
